...
function DiscordCallbackPage() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="w-full max-w-md rounded-lg bg-white p-8 text-center shadow-lg dark:bg-gray-800">
          ...
          <h1 className="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Authentication Successful!</h1>
          <p className="text-gray-600 dark:text-gray-400">Redirecting you back to Spell Coven...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800">
          ...
          <h1 className="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Authentication Failed</h1>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900">
      <div className="w-full max-w-md rounded-lg bg-white p-8 text-center shadow-lg dark:bg-gray-800">
        <div className="mb-4 flex justify-center">
          <svg className="h-16 w-16 animate-spin text-[#5865F2]" fill="none" viewBox="0 0 24 24">
        ...
        <h1 className="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Authenticating...</h1>
        <p className="text-gray-600 dark:text-gray-400">Please wait while we complete your Discord authentication.</p>
      </div>
    </div>
  );
}
