...
import type { DiscordToken, PKCEChallenge } from '@repo/discord-integration'
import { DiscordOAuthClient, isTokenExpired } from '@repo/discord-integration'
  ...
  const handleCallback = useCallback(
    async (code: string) => {
      try {
        ...
        const newToken = await client.exchangeCodeForToken(
          code,
          pkce.codeVerifier,
        )
