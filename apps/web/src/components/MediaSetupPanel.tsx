      ...
      {showHeader && (
        <div className="mb-4 flex items-start justify-between">
          ...
          <button
            ...
            className="rounded-sm text-text-muted opacity-70 ring-offset-surface-1 transition-opacity hover:text-text-secondary hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-text-muted focus:ring-offset-2"
            aria-label="Close"
          >
            <X className="h-4 w-4" />
          </button>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
            ...
            <>
              ...
              {videoEnabled ? (
                <>
                  ...
                  {/* Video Preview */}
                  <div className="relative aspect-video overflow-hidden rounded-lg border border-border-default bg-surface-0">
                    <video
                ...
                /* Camera Off state */
                <div className="relative aspect-video overflow-hidden rounded-lg border border-border-default bg-surface-1">
          ...
          {hasPermissions && videoEnabled && (
            <div
              className={`mt-3 space-y-3 rounded-lg border border-border-default bg-surface-2/50 p-3 ${
                ...
                {!focusCapabilities?.supportsFocus && (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="cursor-help rounded bg-surface-3 px-1.5 py-0.5 text-xs text-text-muted">
                        Not supported
                      </span>
                    </TooltipTrigger>
                    <TooltipContent
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div>
                      ...
                      >
                        <SelectTrigger
                          className={`w-[140px] border-border-strong bg-surface-3 text-sm text-text-secondary ${
                            !focusCapabilities?.supportsFocus
                              ? 'cursor-not-allowed'
                              : ''
                          }`}
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <Label
                  className={audioEnabled ? 'text-text-secondary' : 'text-text-placeholder'}
                >
                  Microphone
                </Label>
              </div>
