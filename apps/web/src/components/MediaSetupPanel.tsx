      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
            ...
            <>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  {videoEnabled ? (
                    <Camera className="text-brand-muted-foreground h-4 w-4" />
                  ) : (
                    <CameraOff className="text-text-placeholder h-4 w-4" />
                  )}
                  <Label
                    className={
                      videoEnabled
                ...
                <div className="border-border-default bg-surface-1 relative aspect-video overflow-hidden rounded-lg border">
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <div className="bg-surface-2 flex h-16 w-16 items-center justify-center rounded-full">
                      <CameraOff className="text-text-placeholder h-8 w-8" />
                    </div>
          ...
          {isCameraFocusControlsEnabled && hasPermissions && videoEnabled && (
            ...
            >
              <div className="flex items-center gap-2">
                <Focus className="text-brand-muted-foreground h-4 w-4" />
                ...
                {!focusCapabilities?.supportsFocus && (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="bg-surface-3 text-text-muted cursor-help rounded px-1.5 py-0.5 text-xs">
                        Not supported
                      </span>
                    </TooltipTrigger>
                    <TooltipContent
                  ...
                  focusCapabilities.focusDistance && (
                    <div className="flex flex-1 items-center gap-3">
                      ...
                      <Slider
                        ...
                        className="[&_[data-slot=slider-range]]:bg-brand [&_[data-slot=slider-thumb]]:border-brand [&_[data-slot=slider-track]]:bg-border-strong flex-1 [&_[data-slot=slider-track]]:h-2"
                      />
        ...
        {hasPermissions && (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                {audioEnabled ? (
                  <Mic className="text-brand-muted-foreground h-4 w-4" />
                ) : (
                  <MicOff className="text-text-placeholder h-4 w-4" />
                )}
                <Label
                  className={
                    audioEnabled
              ...
              <div className="border-border-default bg-surface-1 rounded-lg border p-4">
                <div className="flex items-center gap-3">
                  <div className="bg-surface-2 flex h-10 w-10 items-center justify-center rounded-full">
                    <MicOff className="text-text-placeholder h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-text-muted text-sm">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            <Volume2 className="text-brand-muted-foreground h-4 w-4" />
