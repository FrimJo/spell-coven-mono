  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
        ...
        {/* Header */}
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Connect with Discord</h2>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Sign in with Discord to create or join game sessions with voice chat and video streaming.
          </p>
        </div>
        ...
        <div className="mb-6 space-y-3">
          <div className="flex items-start">
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">Voice chat with other players</span>
          </div>
          <div className="flex items-start">
            <svg className="mr-3 h-5 w-5 flex-shrink-0 text-green-500" fill="currentColor" viewBox="0 0 20 20">
              <path
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">Webcam streaming for card recognition</span>
          </div>
          <div className="flex items-start">
            <svg className="mr-3 h-5 w-5 flex-shrink-0 text-green-500" fill="currentColor" viewBox="0 0 20 20">
              <path
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">Text chat for game events</span>
          </div>
        </div>
        ...
        <p className="mt-4 text-center text-xs text-gray-500 dark:text-gray-400">
          We only access your Discord profile, servers, and voice channels. We never post without your permission.
        </p>
      </div>
    </div>
  );
