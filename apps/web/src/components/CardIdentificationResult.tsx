      ...
      <div className="relative">
        ...
        <div className="border-surface-2 bg-surface-0/50 flex items-center justify-between border-b px-3 py-2">
          <div className="flex items-center gap-2">
            <div className="bg-brand-muted-foreground size-2 rounded-full" />
          ...
          {isLoading && (
            <div className="flex items-center justify-center py-8">
              <div className="flex flex-col items-center gap-2">
                <div className="border-brand-muted-foreground size-8 animate-spin rounded-full border-2 border-t-transparent" />
