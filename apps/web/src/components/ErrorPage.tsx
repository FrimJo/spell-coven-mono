  ...
  return (
    <div className="bg-surface-0 relative min-h-screen overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="bg-destructive/10 absolute left-20 top-20 size-64 animate-pulse rounded-full blur-3xl" />
        <div className="bg-brand/10 absolute bottom-20 right-20 size-96 animate-pulse rounded-full blur-3xl delay-1000" />
      </div>
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <div className="animate-float relative mb-8">
          ...
          <Sparkles className="animate-sparkle text-destructive absolute -right-4 bottom-4 size-5 drop-shadow-[0_0_8px_rgba(248,113,113,0.8)] delay-700" />
        </div>
