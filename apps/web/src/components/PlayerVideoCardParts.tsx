...
export const LocalVideo = memo(function LocalVideo({ videoRef }: LocalVideoProps) {
  return (
    <video
      ref={videoRef}
      autoPlay
...
export const CroppedCanvas = memo(function CroppedCanvas({ croppedRef }: CroppedCanvasProps) {
  return (
    <canvas
      ref={croppedRef}
      width={446}
...
export const FullResCanvas = memo(function FullResCanvas({ fullResRef }: FullResCanvasProps) {
  return (
    <canvas
      ref={fullResRef}
      width={1280}
 ...
 */
export const VideoDisabledPlaceholder = memo(function VideoDisabledPlaceholder() {
  return (
...
export const PlayerNameBadge = memo(function PlayerNameBadge(props: PropsWithChildren) {
  return (
