    ...
    switch (reason) {
      ...
      default:
        return {
          ...
          icon: <DoorOpen className="text-text-muted size-6" />,
      ...
      <DialogContent className="border-surface-2 bg-surface-1 sm:max-w-[450px] [&>button]:hidden">
        <DialogHeader>
          <div className="mb-2 flex justify-center">
            <div
              className={`flex size-12 items-center justify-center rounded-full ${content.iconBg} `}
            >
              {content.icon}
            </div>
          </div>
        ...
        <div className="space-y-3 py-4">
            ...
            >
              <div className="flex items-start gap-3">
                <div className="bg-brand/20 group-hover:bg-brand/30 flex size-10 shrink-0 items-center justify-center rounded-lg transition-colors">
                  <RotateCcw className="text-brand-muted-foreground size-5" />
                </div>
                <div>
          ...
          >
            <div className="flex items-start gap-3">
              <div className="bg-surface-3/50 group-hover:bg-surface-3 flex size-10 shrink-0 items-center justify-center rounded-lg transition-colors">
                <DoorOpen className="text-text-muted size-5" />
              </div>
              <div>
