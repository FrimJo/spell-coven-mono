...
test.describe('Model Setup Validation', () => {
  ...
  test('should have model setup completed by global setup', async ({ page, baseURL }) => {
  ...
  test('should not show loading overlay if model is cached', async ({ page, baseURL }) => {
  ...
  test('should maintain cache across multiple page loads', async ({ page, baseURL }) => {
    // First page load
